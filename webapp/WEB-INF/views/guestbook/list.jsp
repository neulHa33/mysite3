				...
				<div id="guestbook">
					<form action="http://localhost:8080/mysite3/gbc" method="">
						<table id="guestAdd">
							...
							<tbody>
								...
								<tr>
									<td colspan="4"><textarea name="content" cols="72" rows="5" name="content" value=""></textarea></td>
								</tr>
					...
					<table class="guestRead">
						...
						<tr>
							...
							<td><a href="/mysite3/gbc?action=dform&no=<%=guestList.get(i).getNo()%>&password=<%=guestList.get(i).getPassword()%>">[삭제]</a></td>
						</tr>
						<tr>
